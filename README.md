...
This Github repository contains the Python code and modules for the actor-critic algorithm described in our paper [Robust Reinforcement Learning with Dynamic Distortion Risk Measures](https://doi.org/10.1137/24M1699802) by [Anthony Coache](https://anthonycoache.ca/) and [Sebastian Jaimungal](http://sebastian.statistics.utoronto.ca/).
...
For further details, please refer to our [paper](https://doi.org/10.1137/24M1699802) or reach out to us. Thank you for your interest in our research work!
